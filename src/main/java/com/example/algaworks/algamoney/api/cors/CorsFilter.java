package com.example.algaworks.algamoney.api.cors;

import com.example.algaworks.algamoney.api.config.property.AlgamoneyApiProperty;
...
public class CorsFilter implements Filter {
    @Autowired private AlgamoneyApiProperty algamoneyApiProperty;
